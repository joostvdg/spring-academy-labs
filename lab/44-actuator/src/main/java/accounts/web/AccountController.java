...
public class AccountController {
	...
	private final Counter accountFetch;
	...
	public AccountController(AccountManager accountManager, MeterRegistry meterRegistry) {
		...
		accountFetch = this.meterRegistry.counter("account.fetch", "type", "fromCode");
    }
	...
	public List<Account> accountSummary() {
		logger.debug("Testing - Account Summary Invocation");
	 ...
	 */
	@Timed(value = "account.timer", description = "", extraTags = {"source", "accountDetails"})
	@GetMapping(value = "/accounts/{id}")
	public Account accountDetails(@PathVariable int id) {
		accountFetch.increment();
